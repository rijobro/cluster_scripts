...
# USER root
# RUN sudo apt install -y freeglut3-dev libxcb-xfixes0-dev
# USER ${UNAME}

# # Download Qt5, Qt6, QtCreator
# RUN mkdir Qt
# RUN maj=5 && min=15 && patch=2 && \
#     mkdir Qt/Qt${maj} && cd Qt/Qt${maj} && \
...
# RUN maj=6 && min=0 && patch=3 && \
#     mkdir Qt/Qt${maj} && cd Qt/Qt${maj} && \
#     fname=qt-everywhere-src-${maj}.${min}.${patch} && \
#     wget http://download.qt.io/official_releases/qt/${maj}.${min}/${maj}.${min}.${patch}/single/${fname}.tar.xz && \
#     tar -xf ${fname}.tar.xz && mv ${fname} Source
# RUN git clone https://code.qt.io/qt-creator/qt-creator.git Qt/QtCreator/Source

# # # Build Qt5
# RUN cd Qt/Qt5/Source && ./configure -release -opensource -nomake tests -nomake examples -confirm-license -prefix /home/${UNAME}/Qt/Qt5/Install
# RUN cd Qt/Qt5/Source && make -j10
# RUN cd Qt/Qt5/Source && make -j2 || true
# RUN cd Qt/Qt5/Source && make || true

# Build Qt6
# RUN mkdir Qt/Qt6/Build && cd Qt/Qt6/Build && \
#     cmake ../Source/ -G Ninja -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_INSTALL_PREFIX:PATH=/home/${UNAME}/Qt/Qt6/Install && \
#     ninja install

# Qt Creator 5
# RUN cd Qt/Build && \
#     cmake ../Source/ -G Ninja -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_INSTALL_PREFIX:PATH=/home/${UNAME}/Qt/Install && \
#     ninja install
# RUN git clone https://code.qt.io/qt-creator/qt-creator.git QtCreator/Source
# RUN cd QtCreator/Build && \
#     cmake ../Source/ -G Ninja -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_INSTALL_PREFIX:PATH=/home/${UNAME}/QtCreator/Install && \
#     ninja install
...
#     cmake ../Source/ -G Ninja -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_INSTALL_PREFIX:PATH=/home/${UNAME}/QtCreator/Install && \
#     ninja install
# RUN git clone --depth 1 --branch v4.14.2 https://code.qt.io/qt-creator/qt-creator.git QtCreator/Source
# RUN cd QtCreator/Build && /home/${UNAME}/Qt/Install/bin/qmake ../Source/qtcreator.pro
# RUN cd QtCreator/Build && make qmake_all && make install -j10 INSTALL_ROOT=/home/${UNAME}/QtCreator/Install
...
# USER ${UNAME}
# RUN mkdir Qt Qt/Build QtCreator QtCreator/Build
